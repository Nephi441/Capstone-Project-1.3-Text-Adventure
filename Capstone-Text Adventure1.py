...
if weapon_choice == 1 or 2 or 3:
    ...
    if zone_choice == 1:
        ...
        def fight3():
                fdmg1 = int(random.randint(2,8))
                edmg1 = int(random.randint(1,7))
                time.sleep(1)
                if edmg1 > fdmg1:
                    print ('You were not prepared for the DRAGON, and it completely incinerates you with a jet-fast stream of white fire from its throat.')
                    ...
                    if weapon_choice == 1:
                        print ('The DRAGON inhales, and you dodge behind a nearby boulder, bracing yourself as blue-hot fire blasts past you on both sides of the boulder, molten rock surrounding you.')
                        print ('As soon as the fire stops surrounding you, you waste no time and charge the DRAGON. As you approach it, you can feel a powerful force act on your body, engulfing you in bravery and courage.')
                        print ('With this surge of energy and power, you leap 15 feet in the air and deliver a powerful slice straight through the scales of the jaw of the DRAGON.')
                        print ('You observe the agonized reaction of the DRAGON as its jaw drops to the floor and explodes and covers the floor in dark gray dust and ruby powder.')
                        print ('The DRAGON struggles to stand, but before it manages to get back up on any of its limbs you charge it again, this time lunging yourself directly into its chest.')
                        print ('A moment of brief stillness remains between the DRAGONs soul and your own before rays of crimson light and maroon shadow burst from the DRAGONs chest as it writhes with the pain of eons of demons releasing their bonds from the once-innocent soul of what used to be a REPTILIAN DRUID.')
                    if weapon_choice == 2:
                        print ('The DRAGON inhales, and you .')
                    if weapon_choice == 3:
                        print ('The DRAGON inhales, and you .')
